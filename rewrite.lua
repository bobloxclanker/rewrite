...
function Assets:Window(ScreenAsset,Window)
	...
	function Window:Watermark(Watermark)
		...
		ScreenAsset.Watermark.Visible = true
...
function Bracket:Window(Window)
	...
	function Window:Tab(Tab)
		...
		function Tab:Section(Section)
			...
			function Tab:ClearSide(Side)
				Side = Side or "Right" -- default to Right side
				local targetSide = Side == "Left" and TabAsset.LeftSide or TabAsset.RightSide
